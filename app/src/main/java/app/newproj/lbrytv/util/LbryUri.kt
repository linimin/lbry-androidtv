...
class LbryUri private constructor() {
    ...
    private var streamClaimId: String? = null
    private var channelName: String? = null
    private var channelClaimId: String? = null
    private var primaryClaimSequence = 0
    private var secondaryClaimSequence = 0
    private var primaryBidPosition = 0
    private var secondaryBidPosition = 0
    private var claimName: String? = null
    private var claimId: String? = null
    private var contentName: String? = null
    private var queryString: String? = null
    private val isChannelUrl: Boolean
...
class LbryUriException : Exception {
    constructor() : super() {}
